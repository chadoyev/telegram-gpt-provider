...
- **gpt-4o-mini-transcribe** — распознавание голосовых сообщений (точнее Whisper)
...
| Модель        | Описание                                   | Цена (с 20% наценкой)             |
| ------------- | ------------------------------------------ | ---------------------------------- |
| GPT-5.4 Mini  | Быстрая модель для повседневных задач       | $0.90 / $5.40 за 1M токенов       |
| GPT-5.4       | Флагманская модель                          | $3.00 / $18.00 за 1M токенов      |
| gpt-4o-mini-transcribe | Распознавание речи (замена Whisper) | $0.0036 / мин                      |
| gpt-4o-mini-tts | Озвучивание текста (11 голосов)           | $18 / 1M символов                  |
| gpt-image-1.5 | Генерация изображений (замена DALL-E 3)    | $0.041 / изображение (1024x1024)   |
